...
const Management = ({ userRefetch, user }) => {
    ...
    return (
        <div className='p-3 flex flex-col gap-5'>
            ...
            {state ==='none' && (
                <div className="pass flex flex-col gap-3 pt-5 pb-15 items-center">
                    <button onClick={()=>{handleState("password")}} className="text bg-gray-300 h-10 rounded-md flex items-center justify-center w-50">change password</button>
                    <button onClick={()=>{handleState("email")}} className="text bg-gray-300 h-10 rounded-md flex items-center justify-center w-50">change email</button>
                </div>)
            }
            {state === 'password' && (

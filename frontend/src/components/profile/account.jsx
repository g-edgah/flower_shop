    ...
    return (
        <div className="flex flex-col p-3 justify-around gap-10 w-full">
            <div className="title border-b border-gray-300 w-10/10 p-3">
                    <span className="title text-xl font-bold ">Account</span>
            </div>
            <div className="flex justify-between gap-3">
                <div className="account flex flex-col border-[1.75px] border-gray-400 w-5/10 rounded-md bg-gray-200">
                    <div className="title font-bold  flex items-center border-b-1 border-gray-400 w-full p-4 flex justify-between ">
                        <span>Account Details</span> 
                        {!accountEdit ? 
                            <BiSolidEdit onClick={() => {handleAccount(true)}} className="size-6 cursor-pointer hover:text-summaryButtons"/>
                            : 
                            <IoClose onClick={() => {handleAccount(false)}} className="size-6 cursor-pointer hover:text-summaryButtons"/>
                        }
                    </div>

                    { accountEdit ?
                        <form onSubmit={(e) => handleSubmit(e, 'account')} className="edit relative h-full py-4 flex flex-col gap-2 w-full">
                            <div className="address h-10 flex items-center px-4 gap-2">
                    ...
                    :
                        ...
                        <div className="flex flex-col">
                            ...
                            <div className="address h-10 flex items-center p-4 gap-2">
                                ...
                                <span className="text font-semibold">{user.firstName} {user.lastName}</span> 
                            </div>
                        </div>
                    }
                </div>
                <div className="address flex flex-col border w-5/10 rounded-md bg-gray-200  border-gray-400">
                    <div className="title font-bold h-13 flex items-center border-b-1 border-gray-400 w-full p-4 flex justify-between">
                        ...
                        {!addressEdit ? 
                            ...
                            : 
                            <IoClose onClick={() => {handleAddress(false)}} className="size-6 cursor-pointer hover:text-summaryButtons"/>
                        }
                    </div>
